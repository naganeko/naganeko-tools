...
(function e(t, n, r) {
  ...
  1: [function (require, module, exports) {
    ...
    GIFEncoder.prototype.writeComment = function (commentStr) {
      var l = commentStr.length;
      if (0 < l) {
        this.out.writeByte(0x21);
        this.out.writeByte(0xfe);
        this.out.writeByte(Math.min(255,l));
        this.out.writeUTFBytes(commentStr.substr(0,255));
        this.out.writeByte(0x00); // terminator
      }
    };
    ...
    renderFrame = function (frame) {
      ...
      if (frame.last) {
        ...
        if (frame.comment) {
          encoder.writeComment(frame.comment);
        }
        encoder.finish()
      }
