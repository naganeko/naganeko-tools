...
function _d() {
  return spine_gif_extract.core._h.doll;
}
...
function wear_megane(idx) {
  megane = spine_gif_extract.core._h.megane;
  if (megane) {
...
function _d() { return spine_gif_extract.core._h.doll; }
function _s() { return _d().state; }

function _sk() { return _d().skeleton; }
