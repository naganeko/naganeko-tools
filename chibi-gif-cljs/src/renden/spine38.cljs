...
(defn gen-skel [ldr rsc key skin]
  (letfn [(load-skel [k]
    ...
    (let [
          ...
          ;            )))
          ;;atlas (js/PIXI.spine.core.TextureAtlas.
          atlas (js/PIXI.spine.TextureAtlas.
                  rad
          ...
          spineAtlasLoader (js/PIXI.spine.AtlasAttachmentLoader. atlas)

          skelkey (str key "-skel")
          skel-v (aget rsc skelkey)
          data (if skel-v
                 (let [parser (js/PIXI.spine.SkeletonBinary. spineAtlasLoader)
                       skd (js/Uint8Array.
                 ...
                 ;  )
                 (let [
                       parser (js/PIXI.spine.SkeletonJson. spineAtlasLoader)
