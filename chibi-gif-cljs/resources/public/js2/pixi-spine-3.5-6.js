    ...
    var SkeletonJson = (function () {
      ...
      SkeletonJson.prototype.readSkeletonData = function (json) {
        ...
        if (skeletonMap != null) {
          ...
          alert("Some Error.\nContact Naganeko and send your files");
          throw "error";
        }
        ...
        if (!skeletonData.version) {
          if (confirm("WARNING:\nNO Spine version infomation\n"
          + "Is it ok to read as v3.3 Data?\n"
          + "")) {
            skeletonData.version = "3.3";
          } else {
            alert("Loading Stopped");
            throw "no_spine_version";
          }
        }
        ...
        if (root.slots) {
          for (var i = 0; i < root.slots.length; i++) {
            ...
            console.log("slot",i, slotMap.name, dV
              , JSON.stringify(dark)
              , JSON.stringify(data.darkColor)
            );
          }
        }
        if (root.ik) {
      ...
      SkeletonJson.prototype.readAttachment = function (map, skin, slotIndex, name, skeletonData) {
        ...
        switch (type) {
          ...
          case "clipping": {
            ...
            console.log("clipping", name, clip);
            if (clip == null)
              return null;
            var end = this.getValue(map, "end", null);
            if (end != null) {
              // 버그?? 2020-8-9
              var slot = skeletonData.findSlot(end) || skeletonData.slots[end];
              if (slot == null)
      ...
      SkeletonJson.prototype.readVertices = function (map, attachment, verticesLength) {
        ...
        if (verticesLength == vertices.length) {
          ...
          // console.log("mesh", map.name, "len=" , verticesLength);
          return;
        }
        ...
        for (var i = 0, n = vertices.length; i < n;) {
          ...
          // console.log("w mesh", map.name, "i=" , i, "c=", boneCount);
        ...
        var iterateParser = function () {
          while (true) {
            ...
            if (line.length == 0)
              ...
              // var orig = new PIXI.Rectangle(0, 0, width, height);
              // var trim = new PIXI.Rectangle(0, 0, width, height);
