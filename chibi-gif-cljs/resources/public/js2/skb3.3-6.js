...
SkeletonBinary3.prototype = {
  ...
  initJson: function () {
    ...
    let version = skeleton.spine || "0.0.0";
    ...
    if (majorVersion == 3 && (minorVersion == 7 || minorVersion == 8)) {
      goto_s38g();
      throw "not 3";
      return null;
    }
    ...
    renden.skb3.check_skel(minorVersion, this, skeleton, nonessential);
    ...
    renden.skb3.read_bones(minorVersion, this, bones, nonessential);

    // Slots.
    this.json.slots = new Array(this.readInt(true));
    var slots = this.json.slots;

    renden.skb3.read_slots(minorVersion, this, bones, slots, nonessential);
    ...
    for (var i = 0; i < ik.length; i++) {
      ...
      renden.skb3.check_ik(minorVersion, this, ikConstraints);
    ...
    for (var i = 0; i < transform.length; i++) {
      ...
      renden.skb3.check_trs(minorVersion, this, transformConst);
    ...
    for (var i = 0; i < path.length; i++) {
      ...
      renden.skb3.check_path(minorVersion, this, pathConst);
  ...
  readSkin(skinName, nonessential) {
    ...
    // console.log("slotCount", slotCount, "nonessential", nonessential);
    if (slotCount == 0)
      return null;
    var skin = {};
