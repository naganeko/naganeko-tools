...
SkeletonBinary3.prototype = {
  ...
  initJson: function () {
    ...
    {
      let v = skeleton.spine || "";
      if (/^2\./.test(v)) {
        goto_s2g();
        return null;
      }
      // if (/^3\.[01234]./.test(v)) {
      //   alert("Spine " + v + ".\nonly 3.5 and 3.6 is supported, CURRENTLY.");
      // }
    }

    console.log("spine v=", skeleton.spine);
    ...
    for (var i = 0; i < bones.length; i++) {
      ...
      // console.log(n, "bone n=", name);
      if (i != 0) {
        var parentIndex = this.readInt(true);
       console.log(n, "pidx=", parentIndex, "p=", bones[parentIndex]);
