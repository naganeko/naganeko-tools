  ...
  (function (core) {
    ...
    var RotateTimeline = (function (_super) {
      ...
      RotateTimeline.prototype.apply = function (skeleton, lastTime, time, events, alpha, blend, direction) {
        ...
        // console.log("RotTL", bone.data.name, lastTime, time, alpha, blend, direction);
    ...
    var Bone = (function () {
      ...
      Bone.prototype.updateWorldTransformWith = function (x, y, rotation, scaleX, scaleY, shearX, shearY) {
        ...
        if (parent == null) {
          ...
          // console.log("root", rotation, rotationY);
          return;
        }
        // spine-runtime.ts 는 b c 가 반대임
        var pa = parent.matrix.a
          , p_c = parent.matrix.c
          , p_b = parent.matrix.b
          , pd = parent.matrix.d;
        m.tx = pa * x + p_c * y + parent.matrix.tx;
        m.ty = p_b * x + pd * y + parent.matrix.ty;
        switch (this.data.transformMode) {
          case core.TransformMode.Normal: {
            var rotationY = rotation + 90 + shearY;
            var la = core.MathUtils.cosDeg(rotation + shearX) * scaleX;
            var l_b = core.MathUtils.sinDeg(rotation + shearX) * scaleX;
            var l_c = core.MathUtils.cosDeg(rotationY) * scaleY;
            var ld = core.MathUtils.sinDeg(rotationY) * scaleY;
            m.a = pa * la + p_c * l_b;
            m.b = p_b * la + pd * l_b;
            m.c = pa * l_c + p_c * ld;
            m.d = p_b * l_c + pd * ld;
            // console.log(this.data.name, rotation, rotationY);
          ...
          case core.TransformMode.NoRotationOrReflection: {
            ...
            var prx = 0;
            if (s > 0.0001) {
              s = Math.abs(pa * pd - p_c * p_b) / s;
              p_c = p_b * s;
              pd = pa * s;
              prx = Math.atan2(p_b, pa) * core.MathUtils.radDeg;
            } else {
              pa = 0;
              p_b = 0;
              prx = 90 - Math.atan2(pd, p_c) * core.MathUtils.radDeg;
            }
          ...
          case core.TransformMode.NoScaleOrReflection: {
            ...
            var za = (pa * cos + p_c * sin) / sx;
            var zc = (p_b * cos + pd * sin) / sy;
    ...
    var SkeletonBinary = (function () {
      ...
      SkeletonBinary.prototype.readSkeletonData = function (binary) {
        ...
        for (var i = 0; i < n; i++) {
          ...
          console.log("bone:", name_2, parent_2);
