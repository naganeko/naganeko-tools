...
(if-not js/window.skel_map (set! js/window.skel_map #js {}))
(if-not js/window.atlas_text_map (set! js/window.atlas_text_map #js {}))
(if-not js/window.dolls_map (set! js/window.dolls_map #js {}))
...
(defn apply-filter! [sk-jsn skin]
  (let [
    ...
    ;;(js/fn_skins_filter skn sk-jsn skin)
    ;;(js/fn_slots_filter sl sk-jsn bs skin)
    ;;(js/fn_bones_filter bs sk-jsn skin)
    ;;(js/fn_animations_filter ani sk-jsn bs skin)
    ;;(js/fn_skeleton_filter sk-jsn bs sl ani skn skin)
    sk-jsn))
    ...
    (let [
          ...
          atlas (js/PIXI.spine.SpineRuntime.Atlas.
                  ...
                  (fn [s]
                    ...
                    ;(set! js/sd_atlas s)
                    (js/fn_cb_atlas_after_load s skin)
                    ))
